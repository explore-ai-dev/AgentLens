...
def test_display_lines_preserve_historical_tool_summaries_and_hide_task_boundary() -> None:
    messages = [
        AgentMessage(
            id="msg_assistant",
            ...
            parts=[
                MessagePart(
                    ...
                    kind="tool_call",
                    content="",
                    metadata={"tool_name": "view", "arguments": {"path": "README.md"}},
                ),
                MessagePart(
                    id="part_boundary",
                    message_id="msg_assistant",
                    kind="tool_call",
                    content="",
                    metadata={"tool_name": "task_boundary", "arguments": {}},
                ),
            ],
        ),
        AgentMessage(
            ...
            parts=[
                MessagePart(
                    ...
                    kind="tool_result",
                    content="读取成功：你好，世界",
                    metadata={"tool_name": "view", "ok": True},
                ),
                MessagePart(
                    id="part_boundary_result",
                    message_id="msg_tool",
                    kind="tool_result",
                    content="内部边界",
                    metadata={"tool_name": "task_boundary", "ok": True},
                ),
            ],
        ),
    ]
    ...
    assert _display_lines_from_messages(messages) == [
        ...
        "Tool result: view success: 读取成功：你好，世界",
    ]
